...
contract MigrationContractArbitrum3 {
    ...
    function executeMigration(
        ...
        // Populate UPC 4 minted tokenIds (3 items)
            sortedMintedIds.upc4[0] = 4000000007; // Token ID: 4 * 1000000000 + 1
            sortedMintedIds.upc4[1] = 4000000008; // Token ID: 4 * 1000000000 + 2
            sortedMintedIds.upc4[2] = 4000000009; // Token ID: 4 * 1000000000 + 3
        ...
        // Dress Banny 4000000007 (Original)
        {
            ...
            outfitIds[0] = 10000000002; // V4: 10000000002 -> V5: 10000000002
            outfitIds[1] = 20000000002; // V4: 20000000002 -> V5: 20000000002
            outfitIds[2] = 43000000001; // V4: 43000000001 -> V5: 43000000001
        ...
        generatedTokenIds[0] = 4000000007; // Token ID (V4: 4000000007)
        generatedTokenIds[1] = 4000000008; // Token ID (V4: 4000000008)
        generatedTokenIds[2] = 4000000009; // Token ID (V4: 4000000009)
