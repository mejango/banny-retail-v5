...
contract MigrationContractEthereum5 {
    ...
    function executeMigration(
        ...
        // Ethereum migration chunk 5/5 - 35 items
        ...
        // Populate UPC 4 minted tokenIds (22 items)
            sortedMintedIds.upc4[0] = 4000000064; // Token ID: 4 * 1000000000 + 1
            sortedMintedIds.upc4[1] = 4000000065; // Token ID: 4 * 1000000000 + 2
            sortedMintedIds.upc4[2] = 4000000066; // Token ID: 4 * 1000000000 + 3
            sortedMintedIds.upc4[3] = 4000000067; // Token ID: 4 * 1000000000 + 4
            sortedMintedIds.upc4[4] = 4000000068; // Token ID: 4 * 1000000000 + 5
            sortedMintedIds.upc4[5] = 4000000069; // Token ID: 4 * 1000000000 + 6
            sortedMintedIds.upc4[6] = 4000000070; // Token ID: 4 * 1000000000 + 7
            sortedMintedIds.upc4[7] = 4000000071; // Token ID: 4 * 1000000000 + 8
            sortedMintedIds.upc4[8] = 4000000072; // Token ID: 4 * 1000000000 + 9
            sortedMintedIds.upc4[9] = 4000000073; // Token ID: 4 * 1000000000 + 10
            sortedMintedIds.upc4[10] = 4000000074; // Token ID: 4 * 1000000000 + 11
            sortedMintedIds.upc4[11] = 4000000075; // Token ID: 4 * 1000000000 + 12
            sortedMintedIds.upc4[12] = 4000000076; // Token ID: 4 * 1000000000 + 13
            sortedMintedIds.upc4[13] = 4000000077; // Token ID: 4 * 1000000000 + 14
            sortedMintedIds.upc4[14] = 4000000078; // Token ID: 4 * 1000000000 + 15
            sortedMintedIds.upc4[15] = 4000000079; // Token ID: 4 * 1000000000 + 16
            sortedMintedIds.upc4[16] = 4000000080; // Token ID: 4 * 1000000000 + 17
            sortedMintedIds.upc4[17] = 4000000081; // Token ID: 4 * 1000000000 + 18
            sortedMintedIds.upc4[18] = 4000000082; // Token ID: 4 * 1000000000 + 19
            sortedMintedIds.upc4[19] = 4000000083; // Token ID: 4 * 1000000000 + 20
            sortedMintedIds.upc4[20] = 4000000084; // Token ID: 4 * 1000000000 + 21
            sortedMintedIds.upc4[21] = 4000000085; // Token ID: 4 * 1000000000 + 22
        // Populate UPC 6 minted tokenIds (1 items)
            sortedMintedIds.upc6[0] = 6000000008; // Token ID: 6 * 1000000000 + 1
        // Populate UPC 15 minted tokenIds (1 items)
            sortedMintedIds.upc15[0] = 15000000005; // Token ID: 15 * 1000000000 + 1
        // Populate UPC 19 minted tokenIds (3 items)
            sortedMintedIds.upc19[0] = 19000000013; // Token ID: 19 * 1000000000 + 1
            sortedMintedIds.upc19[1] = 19000000014; // Token ID: 19 * 1000000000 + 2
            sortedMintedIds.upc19[2] = 19000000015; // Token ID: 19 * 1000000000 + 3
        ...
        // Populate UPC 31 minted tokenIds (2 items)
            sortedMintedIds.upc31[0] = 31000000007; // Token ID: 31 * 1000000000 + 1
            sortedMintedIds.upc31[1] = 31000000008; // Token ID: 31 * 1000000000 + 2
        // Populate UPC 38 minted tokenIds (1 items)
            sortedMintedIds.upc38[0] = 38000000003; // Token ID: 38 * 1000000000 + 1
        ...
        // Dress Banny 4000000076 (Original)
        {
            ...
            outfitIds[2] = 38000000003; // V4: 38000000001 -> V5: 38000000003
        ...
        generatedTokenIds[0] = 4000000064; // Token ID (V4: 4000000064)
        generatedTokenIds[1] = 4000000065; // Token ID (V4: 4000000065)
        generatedTokenIds[2] = 4000000066; // Token ID (V4: 4000000066)
        generatedTokenIds[3] = 4000000067; // Token ID (V4: 4000000067)
        generatedTokenIds[4] = 4000000068; // Token ID (V4: 4000000068)
        generatedTokenIds[5] = 4000000069; // Token ID (V4: 4000000069)
        generatedTokenIds[6] = 4000000070; // Token ID (V4: 4000000070)
        generatedTokenIds[7] = 4000000071; // Token ID (V4: 4000000071)
        generatedTokenIds[8] = 4000000072; // Token ID (V4: 4000000072)
        generatedTokenIds[9] = 4000000073; // Token ID (V4: 4000000073)
        generatedTokenIds[10] = 4000000074; // Token ID (V4: 4000000074)
        generatedTokenIds[11] = 4000000075; // Token ID (V4: 4000000075)
        generatedTokenIds[12] = 4000000076; // Token ID (V4: 4000000076)
        generatedTokenIds[13] = 4000000077; // Token ID (V4: 4000000077)
        generatedTokenIds[14] = 4000000078; // Token ID (V4: 4000000078)
        generatedTokenIds[15] = 4000000079; // Token ID (V4: 4000000079)
        generatedTokenIds[16] = 4000000080; // Token ID (V4: 4000000080)
        generatedTokenIds[17] = 4000000081; // Token ID (V4: 4000000081)
        generatedTokenIds[18] = 4000000082; // Token ID (V4: 4000000082)
        generatedTokenIds[19] = 4000000083; // Token ID (V4: 4000000083)
        generatedTokenIds[20] = 4000000084; // Token ID (V4: 4000000084)
        generatedTokenIds[21] = 4000000085; // Token ID (V4: 4000000085)
