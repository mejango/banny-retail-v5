...
contract MigrationContractEthereum4 {
    ...
    function executeMigration(
        ...
        // Populate UPC 4 minted tokenIds (20 items)
            sortedMintedIds.upc4[0] = 4000000028; // Token ID: 4 * 1000000000 + 1
            sortedMintedIds.upc4[1] = 4000000029; // Token ID: 4 * 1000000000 + 2
            sortedMintedIds.upc4[2] = 4000000030; // Token ID: 4 * 1000000000 + 3
            sortedMintedIds.upc4[3] = 4000000031; // Token ID: 4 * 1000000000 + 4
            sortedMintedIds.upc4[4] = 4000000032; // Token ID: 4 * 1000000000 + 5
            sortedMintedIds.upc4[5] = 4000000033; // Token ID: 4 * 1000000000 + 6
            sortedMintedIds.upc4[6] = 4000000034; // Token ID: 4 * 1000000000 + 7
            sortedMintedIds.upc4[7] = 4000000035; // Token ID: 4 * 1000000000 + 8
            sortedMintedIds.upc4[8] = 4000000036; // Token ID: 4 * 1000000000 + 9
            sortedMintedIds.upc4[9] = 4000000037; // Token ID: 4 * 1000000000 + 10
            sortedMintedIds.upc4[10] = 4000000038; // Token ID: 4 * 1000000000 + 11
            sortedMintedIds.upc4[11] = 4000000039; // Token ID: 4 * 1000000000 + 12
            sortedMintedIds.upc4[12] = 4000000040; // Token ID: 4 * 1000000000 + 13
            sortedMintedIds.upc4[13] = 4000000041; // Token ID: 4 * 1000000000 + 14
            sortedMintedIds.upc4[14] = 4000000042; // Token ID: 4 * 1000000000 + 15
            sortedMintedIds.upc4[15] = 4000000043; // Token ID: 4 * 1000000000 + 16
            sortedMintedIds.upc4[16] = 4000000044; // Token ID: 4 * 1000000000 + 17
            sortedMintedIds.upc4[17] = 4000000045; // Token ID: 4 * 1000000000 + 18
            sortedMintedIds.upc4[18] = 4000000046; // Token ID: 4 * 1000000000 + 19
            sortedMintedIds.upc4[19] = 4000000047; // Token ID: 4 * 1000000000 + 20
        ...
        // Populate UPC 19 minted tokenIds (2 items)
            sortedMintedIds.upc19[0] = 19000000008; // Token ID: 19 * 1000000000 + 1
            sortedMintedIds.upc19[1] = 19000000009; // Token ID: 19 * 1000000000 + 2
        ...
        // Populate UPC 25 minted tokenIds (2 items)
            ...
            sortedMintedIds.upc25[1] = 25000000007; // Token ID: 25 * 1000000000 + 2
        ...
        // Populate UPC 42 minted tokenIds (1 items)
            sortedMintedIds.upc42[0] = 42000000003; // Token ID: 42 * 1000000000 + 1
        ...
        generatedTokenIds[0] = 4000000028; // Token ID (V4: 4000000028)
        generatedTokenIds[1] = 4000000029; // Token ID (V4: 4000000029)
        generatedTokenIds[2] = 4000000030; // Token ID (V4: 4000000030)
        generatedTokenIds[3] = 4000000031; // Token ID (V4: 4000000031)
        generatedTokenIds[4] = 4000000032; // Token ID (V4: 4000000032)
        generatedTokenIds[5] = 4000000033; // Token ID (V4: 4000000033)
        generatedTokenIds[6] = 4000000034; // Token ID (V4: 4000000034)
        generatedTokenIds[7] = 4000000035; // Token ID (V4: 4000000035)
        generatedTokenIds[8] = 4000000036; // Token ID (V4: 4000000036)
        generatedTokenIds[9] = 4000000037; // Token ID (V4: 4000000037)
        generatedTokenIds[10] = 4000000038; // Token ID (V4: 4000000038)
        generatedTokenIds[11] = 4000000039; // Token ID (V4: 4000000039)
        generatedTokenIds[12] = 4000000040; // Token ID (V4: 4000000040)
        generatedTokenIds[13] = 4000000041; // Token ID (V4: 4000000041)
        generatedTokenIds[14] = 4000000042; // Token ID (V4: 4000000042)
        generatedTokenIds[15] = 4000000043; // Token ID (V4: 4000000043)
        generatedTokenIds[16] = 4000000044; // Token ID (V4: 4000000044)
        generatedTokenIds[17] = 4000000045; // Token ID (V4: 4000000045)
        generatedTokenIds[18] = 4000000046; // Token ID (V4: 4000000046)
        generatedTokenIds[19] = 4000000047; // Token ID (V4: 4000000047)
