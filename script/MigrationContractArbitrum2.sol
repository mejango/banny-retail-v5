...
contract MigrationContractArbitrum2 {
    ...
    function executeMigration(
        ...
        // Populate UPC 4 minted tokenIds (4 items)
            sortedMintedIds.upc4[0] = 4000000003; // Token ID: 4 * 1000000000 + 1
            sortedMintedIds.upc4[1] = 4000000004; // Token ID: 4 * 1000000000 + 2
            sortedMintedIds.upc4[2] = 4000000005; // Token ID: 4 * 1000000000 + 3
            sortedMintedIds.upc4[3] = 4000000006; // Token ID: 4 * 1000000000 + 4
        ...
        // Populate UPC 19 minted tokenIds (1 items)
            sortedMintedIds.upc19[0] = 19000000002; // Token ID: 19 * 1000000000 + 1
        ...
        // Dress Banny 4000000003 (Original)
        {
            ...
            outfitIds[1] = 19000000002; // V4: 19000000003 -> V5: 19000000002
        ...
        // Dress Banny 4000000004 (Original)
        {
            ...
            outfitIds[0] = 10000000001; // V4: 10000000001 -> V5: 10000000001
        ...
        {
            uint256[] memory outfitIds = new uint256[](2);
            outfitIds[0] = 31000000001; // V4: 31000000001 -> V5: 31000000001
        ...
        generatedTokenIds[0] = 4000000003; // Token ID (V4: 4000000003)
        generatedTokenIds[1] = 4000000004; // Token ID (V4: 4000000004)
        generatedTokenIds[2] = 4000000005; // Token ID (V4: 4000000005)
        generatedTokenIds[3] = 4000000006; // Token ID (V4: 4000000006)
