...
contract MigrationContractEthereum2 {
    ...
    function executeMigration(
        ...
        // Populate UPC 3 minted tokenIds (13 items)
            sortedMintedIds.upc3[0] = 3000000014; // Token ID: 3 * 1000000000 + 1
            sortedMintedIds.upc3[1] = 3000000015; // Token ID: 3 * 1000000000 + 2
            sortedMintedIds.upc3[2] = 3000000016; // Token ID: 3 * 1000000000 + 3
            sortedMintedIds.upc3[3] = 3000000017; // Token ID: 3 * 1000000000 + 4
            sortedMintedIds.upc3[4] = 3000000018; // Token ID: 3 * 1000000000 + 5
            sortedMintedIds.upc3[5] = 3000000019; // Token ID: 3 * 1000000000 + 6
            sortedMintedIds.upc3[6] = 3000000020; // Token ID: 3 * 1000000000 + 7
            sortedMintedIds.upc3[7] = 3000000021; // Token ID: 3 * 1000000000 + 8
            sortedMintedIds.upc3[8] = 3000000022; // Token ID: 3 * 1000000000 + 9
            sortedMintedIds.upc3[9] = 3000000023; // Token ID: 3 * 1000000000 + 10
            sortedMintedIds.upc3[10] = 3000000024; // Token ID: 3 * 1000000000 + 11
            sortedMintedIds.upc3[11] = 3000000025; // Token ID: 3 * 1000000000 + 12
            sortedMintedIds.upc3[12] = 3000000026; // Token ID: 3 * 1000000000 + 13
        ...
        // Populate UPC 5 minted tokenIds (1 items)
            sortedMintedIds.upc5[0] = 5000000004; // Token ID: 5 * 1000000000 + 1
        ...
        // Populate UPC 25 minted tokenIds (2 items)
            sortedMintedIds.upc25[0] = 25000000002; // Token ID: 25 * 1000000000 + 1
            sortedMintedIds.upc25[1] = 25000000003; // Token ID: 25 * 1000000000 + 2
        ...
        // Dress Banny 3000000017 (Orange)
        {
            ...
            outfitIds[0] = 25000000002; // V4: 25000000005 -> V5: 25000000002
        ...
        // Dress Banny 3000000022 (Orange)
        {
            ...
            outfitIds[0] = 19000000004; // V4: 19000000015 -> V5: 19000000004
        ...
        // Dress Banny 3000000023 (Orange)
        {
            ...
            outfitIds[1] = 25000000003; // V4: 25000000008 -> V5: 25000000003
        ...
        generatedTokenIds[0] = 3000000014; // Token ID (V4: 3000000014)
        generatedTokenIds[1] = 3000000015; // Token ID (V4: 3000000015)
        generatedTokenIds[2] = 3000000016; // Token ID (V4: 3000000016)
        generatedTokenIds[3] = 3000000017; // Token ID (V4: 3000000017)
        generatedTokenIds[4] = 3000000018; // Token ID (V4: 3000000018)
        generatedTokenIds[5] = 3000000019; // Token ID (V4: 3000000019)
        generatedTokenIds[6] = 3000000020; // Token ID (V4: 3000000020)
        generatedTokenIds[7] = 3000000021; // Token ID (V4: 3000000021)
        generatedTokenIds[8] = 3000000022; // Token ID (V4: 3000000022)
        generatedTokenIds[9] = 3000000023; // Token ID (V4: 3000000023)
        generatedTokenIds[10] = 3000000024; // Token ID (V4: 3000000024)
        generatedTokenIds[11] = 3000000025; // Token ID (V4: 3000000025)
        generatedTokenIds[12] = 3000000026; // Token ID (V4: 3000000026)
