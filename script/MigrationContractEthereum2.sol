...
contract MigrationContractEthereum2 {
    ...
    function executeMigration(
        ...
        // Ethereum migration chunk 2/5 - 53 items
        ...
        // Populate UPC 3 minted tokenIds (9 items)
            sortedMintedIds.upc3[0] = 3000000018; // Token ID: 3 * 1000000000 + 1
            sortedMintedIds.upc3[1] = 3000000019; // Token ID: 3 * 1000000000 + 2
            sortedMintedIds.upc3[2] = 3000000020; // Token ID: 3 * 1000000000 + 3
            sortedMintedIds.upc3[3] = 3000000021; // Token ID: 3 * 1000000000 + 4
            sortedMintedIds.upc3[4] = 3000000022; // Token ID: 3 * 1000000000 + 5
            sortedMintedIds.upc3[5] = 3000000023; // Token ID: 3 * 1000000000 + 6
            sortedMintedIds.upc3[6] = 3000000024; // Token ID: 3 * 1000000000 + 7
            sortedMintedIds.upc3[7] = 3000000025; // Token ID: 3 * 1000000000 + 8
            sortedMintedIds.upc3[8] = 3000000026; // Token ID: 3 * 1000000000 + 9
        // Populate UPC 4 minted tokenIds (15 items)
        ...
        // Populate UPC 6 minted tokenIds (2 items)
            sortedMintedIds.upc6[0] = 6000000004; // Token ID: 6 * 1000000000 + 1
            sortedMintedIds.upc6[1] = 6000000005; // Token ID: 6 * 1000000000 + 2
        ...
        // Populate UPC 19 minted tokenIds (3 items)
            sortedMintedIds.upc19[0] = 19000000004; // Token ID: 19 * 1000000000 + 1
            sortedMintedIds.upc19[1] = 19000000005; // Token ID: 19 * 1000000000 + 2
            sortedMintedIds.upc19[2] = 19000000006; // Token ID: 19 * 1000000000 + 3
        ...
        // Populate UPC 25 minted tokenIds (3 items)
            sortedMintedIds.upc25[0] = 25000000003; // Token ID: 25 * 1000000000 + 1
            sortedMintedIds.upc25[1] = 25000000004; // Token ID: 25 * 1000000000 + 2
            sortedMintedIds.upc25[2] = 25000000005; // Token ID: 25 * 1000000000 + 3
        ...
        // Populate UPC 37 minted tokenIds (1 items)
            sortedMintedIds.upc37[0] = 37000000002; // Token ID: 37 * 1000000000 + 1
        ...
        // Populate UPC 39 minted tokenIds (1 items)
            sortedMintedIds.upc39[0] = 39000000002; // Token ID: 39 * 1000000000 + 1
        ...
        // Populate UPC 48 minted tokenIds (1 items)
            sortedMintedIds.upc48[0] = 48000000002; // Token ID: 48 * 1000000000 + 1
        ...
        // Dress Banny 3000000022 (Orange)
        {
            ...
            outfitIds[0] = 19000000006; // V4: 19000000015 -> V5: 19000000006
        ...
        // Dress Banny 3000000023 (Orange)
        {
            ...
            outfitIds[1] = 25000000005; // V4: 25000000008 -> V5: 25000000005
        ...
        {
            uint256[] memory outfitIds = new uint256[](3);
            outfitIds[0] = 15000000002; // V4: 15000000004 -> V5: 15000000002
        ...
        // Dress Banny 4000000009 (Original)
        {
            ...
            outfitIds[1] = 19000000004; // V4: 19000000002 -> V5: 19000000004
            outfitIds[2] = 25000000003; // V4: 25000000002 -> V5: 25000000003
        ...
        // Dress Banny 4000000014 (Original)
        {
            ...
            outfitIds[1] = 19000000005; // V4: 19000000004 -> V5: 19000000005
            outfitIds[2] = 25000000004; // V4: 25000000003 -> V5: 25000000004
        ...
        generatedTokenIds[0] = 3000000018; // Token ID (V4: 3000000018)
        generatedTokenIds[1] = 3000000019; // Token ID (V4: 3000000019)
        generatedTokenIds[2] = 3000000020; // Token ID (V4: 3000000020)
        generatedTokenIds[3] = 3000000021; // Token ID (V4: 3000000021)
        generatedTokenIds[4] = 3000000022; // Token ID (V4: 3000000022)
        generatedTokenIds[5] = 3000000023; // Token ID (V4: 3000000023)
        generatedTokenIds[6] = 3000000024; // Token ID (V4: 3000000024)
        generatedTokenIds[7] = 3000000025; // Token ID (V4: 3000000025)
        generatedTokenIds[8] = 3000000026; // Token ID (V4: 3000000026)
        generatedTokenIds[9] = 4000000001; // Token ID (V4: 4000000001)
        generatedTokenIds[10] = 4000000002; // Token ID (V4: 4000000002)
        generatedTokenIds[11] = 4000000003; // Token ID (V4: 4000000003)
        generatedTokenIds[12] = 4000000004; // Token ID (V4: 4000000004)
        generatedTokenIds[13] = 4000000005; // Token ID (V4: 4000000005)
        generatedTokenIds[14] = 4000000006; // Token ID (V4: 4000000006)
        generatedTokenIds[15] = 4000000007; // Token ID (V4: 4000000007)
        generatedTokenIds[16] = 4000000008; // Token ID (V4: 4000000008)
        generatedTokenIds[17] = 4000000009; // Token ID (V4: 4000000009)
        generatedTokenIds[18] = 4000000010; // Token ID (V4: 4000000010)
        generatedTokenIds[19] = 4000000011; // Token ID (V4: 4000000011)
        generatedTokenIds[20] = 4000000012; // Token ID (V4: 4000000012)
        generatedTokenIds[21] = 4000000013; // Token ID (V4: 4000000013)
        generatedTokenIds[22] = 4000000014; // Token ID (V4: 4000000014)
        generatedTokenIds[23] = 4000000015; // Token ID (V4: 4000000015)
