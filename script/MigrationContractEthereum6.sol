...
contract MigrationContractEthereum6 {
    ...
    function executeMigration(
        ...
        // Populate UPC 4 minted tokenIds (18 items)
            sortedMintedIds.upc4[0] = 4000000068; // Token ID: 4 * 1000000000 + 1
            sortedMintedIds.upc4[1] = 4000000069; // Token ID: 4 * 1000000000 + 2
            sortedMintedIds.upc4[2] = 4000000070; // Token ID: 4 * 1000000000 + 3
            sortedMintedIds.upc4[3] = 4000000071; // Token ID: 4 * 1000000000 + 4
            sortedMintedIds.upc4[4] = 4000000072; // Token ID: 4 * 1000000000 + 5
            sortedMintedIds.upc4[5] = 4000000073; // Token ID: 4 * 1000000000 + 6
            sortedMintedIds.upc4[6] = 4000000074; // Token ID: 4 * 1000000000 + 7
            sortedMintedIds.upc4[7] = 4000000075; // Token ID: 4 * 1000000000 + 8
            sortedMintedIds.upc4[8] = 4000000076; // Token ID: 4 * 1000000000 + 9
            sortedMintedIds.upc4[9] = 4000000077; // Token ID: 4 * 1000000000 + 10
            sortedMintedIds.upc4[10] = 4000000078; // Token ID: 4 * 1000000000 + 11
            sortedMintedIds.upc4[11] = 4000000079; // Token ID: 4 * 1000000000 + 12
            sortedMintedIds.upc4[12] = 4000000080; // Token ID: 4 * 1000000000 + 13
            sortedMintedIds.upc4[13] = 4000000081; // Token ID: 4 * 1000000000 + 14
            sortedMintedIds.upc4[14] = 4000000082; // Token ID: 4 * 1000000000 + 15
            sortedMintedIds.upc4[15] = 4000000083; // Token ID: 4 * 1000000000 + 16
            sortedMintedIds.upc4[16] = 4000000084; // Token ID: 4 * 1000000000 + 17
            sortedMintedIds.upc4[17] = 4000000085; // Token ID: 4 * 1000000000 + 18
        ...
        generatedTokenIds[0] = 4000000068; // Token ID (V4: 4000000068)
        generatedTokenIds[1] = 4000000069; // Token ID (V4: 4000000069)
        generatedTokenIds[2] = 4000000070; // Token ID (V4: 4000000070)
        generatedTokenIds[3] = 4000000071; // Token ID (V4: 4000000071)
        generatedTokenIds[4] = 4000000072; // Token ID (V4: 4000000072)
        generatedTokenIds[5] = 4000000073; // Token ID (V4: 4000000073)
        generatedTokenIds[6] = 4000000074; // Token ID (V4: 4000000074)
        generatedTokenIds[7] = 4000000075; // Token ID (V4: 4000000075)
        generatedTokenIds[8] = 4000000076; // Token ID (V4: 4000000076)
        generatedTokenIds[9] = 4000000077; // Token ID (V4: 4000000077)
        generatedTokenIds[10] = 4000000078; // Token ID (V4: 4000000078)
        generatedTokenIds[11] = 4000000079; // Token ID (V4: 4000000079)
        generatedTokenIds[12] = 4000000080; // Token ID (V4: 4000000080)
        generatedTokenIds[13] = 4000000081; // Token ID (V4: 4000000081)
        generatedTokenIds[14] = 4000000082; // Token ID (V4: 4000000082)
        generatedTokenIds[15] = 4000000083; // Token ID (V4: 4000000083)
        generatedTokenIds[16] = 4000000084; // Token ID (V4: 4000000084)
        generatedTokenIds[17] = 4000000085; // Token ID (V4: 4000000085)
